...
- For xUnit v3 migrations in this repo, the assertion package name is `xunit.v3.assert` (singular), and replacing `FluentAssertions` only required package/global-using cleanup plus native `Assert.*` updates in the unit tests.
